...
> **用途**：保留 Seafile 6、Travis CI 与旧 Docker Hub tag 发布流程。
> **适用版本**：示例为 Seafile 6.0.5/6.0.7；CloudFile 14 不适用。
> **状态**：已失效并归档；当前构建与发布以 `release.yaml`、GitHub Actions 和 `build/cloudfile_14.0/` 为准。
